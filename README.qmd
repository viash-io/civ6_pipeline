...
Install Viash and Nextflow in a directory that are on the `$PATH`, e.g. `$HOME/bin`.
...
Note that this pipeline may not extend its support beyond the specific assets used in [this video](https://www.youtube.com/watch?v=wxw3T9589-c). Rendering other world leaders, wonders, and additional elements may require further development.
...
![Comic by Mart Virkus, https://arcaderage.co/2016/10/18/civilization-vi/](docs/images/mart_virkus_every_civilization_game_ever.jpg)
...
That's why a perfect way of closing a session of Civilization V is by being able to watch a 'postgame map replay' of which owner owned which tile at any given point in time.
