...
let par = {
  'input': $( if [ ! -z ${VIASH_PAR_INPUT+x} ]; then echo "'${VIASH_PAR_INPUT//\\'/\\\\\\'}'"; else echo undefined; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "'${VIASH_PAR_OUTPUT//\\'/\\\\\\'}'"; else echo undefined; fi )
};
let meta = {
  'functionality_name': $( if [ ! -z ${VIASH_META_FUNCTIONALITY_NAME+x} ]; then echo "'${VIASH_META_FUNCTIONALITY_NAME//\\'/\\\\\\'}'"; else echo undefined; fi ),
  'resources_dir': $( if [ ! -z ${VIASH_META_RESOURCES_DIR+x} ]; then echo "'${VIASH_META_RESOURCES_DIR//\\'/\\\\\\'}'"; else echo undefined; fi ),
  'executable': $( if [ ! -z ${VIASH_META_EXECUTABLE+x} ]; then echo "'${VIASH_META_EXECUTABLE//\\'/\\\\\\'}'"; else echo undefined; fi ),
  'temp_dir': $( if [ ! -z ${VIASH_TEMP+x} ]; then echo "'${VIASH_TEMP//\\'/\\\\\\'}'"; else echo undefined; fi ),
  'n_proc': $( if [ ! -z ${VIASH_META_N_PROC+x} ]; then echo "'${VIASH_META_N_PROC//\\'/\\\\\\'}'"; else echo undefined; fi ),
  'memory_b': $( if [ ! -z ${VIASH_META_MEMORY_B+x} ]; then echo "'${VIASH_META_MEMORY_B//\\'/\\\\\\'}'"; else echo undefined; fi ),
  'memory_kb': $( if [ ! -z ${VIASH_META_MEMORY_KB+x} ]; then echo "'${VIASH_META_MEMORY_KB//\\'/\\\\\\'}'"; else echo undefined; fi ),
  'memory_mb': $( if [ ! -z ${VIASH_META_MEMORY_MB+x} ]; then echo "'${VIASH_META_MEMORY_MB//\\'/\\\\\\'}'"; else echo undefined; fi ),
  'memory_gb': $( if [ ! -z ${VIASH_META_MEMORY_GB+x} ]; then echo "'${VIASH_META_MEMORY_GB//\\'/\\\\\\'}'"; else echo undefined; fi ),
  'memory_tb': $( if [ ! -z ${VIASH_META_MEMORY_TB+x} ]; then echo "'${VIASH_META_MEMORY_TB//\\'/\\\\\\'}'"; else echo undefined; fi ),
  'memory_pb': $( if [ ! -z ${VIASH_META_MEMORY_PB+x} ]; then echo "'${VIASH_META_MEMORY_PB//\\'/\\\\\\'}'"; else echo undefined; fi )
};
