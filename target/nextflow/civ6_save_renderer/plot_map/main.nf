  ...
  "resources" : [
    {
      ...
      "path" : "script.R",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/civ6_pipeline/civ6_pipeline/src/civ6_save_renderer/plot_map/config.vsh.yaml"
    },
    {
      "type" : "file",
      "path" : "helper.R",
...
par <- list(
  "yaml" = $( if [ ! -z ${VIASH_PAR_YAML+x} ]; then echo "paste0(r'(${VIASH_PAR_YAML//\\'/)\\', \\"\\'\\", r\\'(})')"; else echo NULL; fi ),
  "tsv" = $( if [ ! -z ${VIASH_PAR_TSV+x} ]; then echo "paste0(r'(${VIASH_PAR_TSV//\\'/)\\', \\"\\'\\", r\\'(})')"; else echo NULL; fi ),
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-io/civ6_pipeline/civ6_save_renderer_plot_map",
    "tag" : "main_build"
  }
}'''),
  // auto settings
