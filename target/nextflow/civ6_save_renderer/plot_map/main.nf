...
par <- list(
  "yaml" = $( if [ ! -z ${VIASH_PAR_YAML+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_YAML" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
  "tsv" = $( if [ ! -z ${VIASH_PAR_TSV+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_TSV" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-io/civ6_pipeline/civ6_save_renderer/plot_map",
    "tag" : "main_build"
  }
}'''),
  // auto settings
