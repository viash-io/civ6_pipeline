  ...
  "resources" : [
    {
      ...
      "path" : "script.sh",
      "is_executable" : true,
      "parent" : "file:/home/runner/work/civ6_pipeline/civ6_pipeline/src/civ6_save_renderer/combine_plots/config.vsh.yaml"
    }
  ],
...
$( if [ ! -z ${VIASH_PAR_FRAMERATE+x} ]; then echo "${VIASH_PAR_FRAMERATE}" | sed "s#'#'\\"'\\"'#g" | sed "s#.*#par_framerate='&'#" ; fi )
