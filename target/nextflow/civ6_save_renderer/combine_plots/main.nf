...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/civ6_pipeline/civ6_pipeline/src/civ6_save_renderer/combine_plots/"
      }
    ],
  ...
  "info" : {
    "config" : "/home/runner/work/civ6_pipeline/civ6_pipeline/src/civ6_save_renderer/combine_plots/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.7.3",
...
$( if [ ! -z ${VIASH_PAR_FRAMERATE+x} ]; then echo "${VIASH_PAR_FRAMERATE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_framerate='&'#" ; else echo "# par_framerate="; fi )
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-io/civ6_pipeline/civ6_save_renderer/combine_plots",
    "tag" : "main_build"
  }
}'''),
  // auto settings
