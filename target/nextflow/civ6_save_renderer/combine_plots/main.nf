...
thisHelpMessage = '''combine_plots main_build

Combine multiple images into a movie using ffmpeg.

Options:
    --input
        type: file, required parameter, multiple values allowed, file must exist
        example: /path/to/my/dir
        A list of images.
...
$( if [ ! -z ${VIASH_PAR_FRAMERATE+x} ]; then echo "par_framerate='${VIASH_PAR_FRAMERATE//\\'/\\'\\"\\'\\"\\'}'"; fi )
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-io/civ6_pipeline/civ6_save_renderer_combine_plots",
    "tag" : "main_build"
  }
}"""),
  // auto settings
